...
#"61", "62", "63", "64", "65", "66", "67", "68", "69", "6a", "6b", "6c", "6d", "6e", "6f", "70", "71", "72", "73", "74", "75", "76", "77", "78", "79", "7a"] #Lower case
    ...
    NumImagesPerClassTrain = 400
    NumImagesPerClassValidation = 100
    ...
    for glyph in classes:
        ...
        #for image_path in glob.glob("./by_class/"+glyph+"/train_"+glyph+"/*.png"):
            if (i < NumImagesPerClassTrain):
                ...
                picture_train = misc.imresize(pic_train, (128,128))
                ...
                picture_valid = misc.imresize(pic_valid, (128,128))
        ...
        #for image_path in glob.glob("./by_class/"+glyph+"/hsf_4/*.png"):
            if (k < NumImagesPerClassTest):
                ...
                picture_test = misc.imresize(pic_test, (128,128))
    ...
    labelsTrain = np.float32(np.eye(5)[labelsTrain])
    ...
    labelsTest = np.float32(np.eye(5)[labelsTest])
    ...
    labelsValidation = np.float32(np.eye(5)[labelsValidation])
